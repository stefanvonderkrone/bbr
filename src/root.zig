...
pub const diff = struct {
    ...
    pub const DiffSource = source.DiffSource;
    pub const TextDiffSource = source.TextSource;
    pub const GitDiffSource = source.GitSource;
    pub const File = model.File;
    pub const FileBlob = model.FileBlob;
    pub const FileStatus = model.FileStatus;
    pub const FileContent = model.FileContent;
    pub const FileContentStatus = model.FileContentStatus;
    pub const UnavailableReason = model.UnavailableReason;
...
pub const review = struct {
    ...
    pub const anchor = @import("review/anchor.zig");
    pub const Comment = comment.Comment;
    pub const CommentId = comment.CommentId;
    pub const Anchor = comment.Anchor;
    pub const FileScope = comment.FileScope;
    pub const CommentScope = comment.CommentScope;
    pub const AnchorSnapshot = comment.AnchorSnapshot;
    pub const AnchorState = comment.AnchorState;
    pub const ScopeState = comment.ScopeState;
    pub const AnchorResolution = anchor.AnchorResolution;
    pub const AnchorResolver = anchor.AnchorResolver;
    pub const GitAnchorResolver = anchor.GitAnchorResolver;
    pub const AnchorProjectionEntry = anchor.ProjectionEntry;
    pub const ScopeResolution = anchor.ScopeResolution;
    pub const ScopeResolver = anchor.ScopeResolver;
    pub const ScopeProjectionEntry = anchor.ScopeProjectionEntry;
    ...
    pub const RemoteReviewIdentity = store.RemoteReviewIdentity;
    pub const ReviewRepositoryId = store.ReviewRepositoryId;
    ...
    pub const SubmissionRetryCheckpoint = store.SubmissionRetryCheckpoint;
    pub const SubmissionRetryPhase = store.SubmissionRetryPhase;
    pub const SubmissionRetryReason = store.SubmissionRetryReason;
    ...
    pub const DraftBodyEdit = store.DraftBodyEdit;
    pub const DraftReanchor = store.DraftReanchor;
    pub const DraftSubtreeDelete = store.DraftSubtreeDelete;
    pub const DraftEditError = store.DraftEditError;
    pub const validateCascadeShape = store.validateCascadeShape;
    pub const containsTempId = store.containsTempId;
    pub const descendsFrom = draft.descendsFrom;
    pub const max_anchor_lines = comment.max_anchor_lines;
    pub const parentEql = store.parentEql;
    pub const storedBody = draft.storedBody;
    pub const isBlankBody = draft.isBlankBody;
    ...
    pub const PostResult = submission.PostResult;
    pub const CheckResult = submission.CheckResult;
    pub const CheckOutcome = submission.CheckOutcome;
...
pub const git = struct {
    ...
    pub const ResolvedRef = client_mod.ResolvedRef;
    pub const Worktree = client_mod.Worktree;
};
