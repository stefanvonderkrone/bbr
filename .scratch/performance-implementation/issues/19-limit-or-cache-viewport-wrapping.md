...
The 19.88-second changed Time Profiler trace (`viewport-wrap-changed-time.trace`) and the 18.64-second changed CPU Counters trace (`viewport-wrap-changed-counters.trace`) each ran 4,000 repetitions. The macOS Allocations template did not finalize within 180 seconds for either 4,000 or 10 repetitions. The benchmark allocator supplies the allocation evidence.
